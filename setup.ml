...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7a4d9ec7fb6cee8092e034f9dd4203ee) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Signatures of the category theoretic style";
          description = None;
          categories = [];
            ...
            [
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Cats";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/tel/ocaml-cats";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ÈüÝ\n\t\024é\133T*\027ä\140s\012\000";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
